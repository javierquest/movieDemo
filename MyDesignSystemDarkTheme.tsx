    ...
    styleOverrides: {
      root: {
        ...
        "&.MuiRadio-colorSecondary": {
          ...
          "&:hover": {
            backgroundColor: `rgba(26, 157, 252, 0.08)`, 
          }
        },
        "&.MuiRadio-colorError": {
          color: `rgba(255, 255, 255, 0.7)`,
      ...
      styleOverrides: {
        ...
        track: {
          ...
          ".Mui-checked.MuiSwitch-colorPrimary.Mui-checked + &": {
            backgroundColor: "rgba(174, 172, 255, 1)"
          },
          ".MuiSwitch-colorSecondary + &": {
            borderRadius: "10px",
            backgroundColor: "rgba(255, 255, 255, 1)"
          ...
          ".Mui-checked.MuiSwitch-colorSecondary.Mui-checked + &": {
            backgroundColor: "rgba(26, 157, 252, 1)"
          },
          ".MuiSwitch-colorError + &": {
            borderRadius: "10px",
            backgroundColor: "rgba(255, 255, 255, 1)"
          ...
          ".Mui-checked.MuiSwitch-colorWarning.Mui-checked + &": {
            backgroundColor: "rgba(63, 61, 60, 1)"
          },
          ".MuiSwitch-colorSuccess + &": {
            borderRadius: "10px",
            backgroundColor: "rgba(255, 255, 255, 1)"
          ...
          ".Mui-checked.MuiSwitch-colorInfo.Mui-checked + &": {
            backgroundColor: "rgba(83, 177, 245, 1)"
          },    
        }
      }  
    },
